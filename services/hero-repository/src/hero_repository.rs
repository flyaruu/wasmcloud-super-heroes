use crate::{bindings::{exports::hti::superheroes::hero_repository::Guest, hti::superheroes::types::Hero, wasi::logging::logging::{log, Level}, wasmcloud::postgres::query::{query, PgValue}}, heroes::SqlHero};
