...
use bindings::{exports::wasi::http::incoming_handler::Guest, hti::superheroes::hero_repository::{get_all_heroes, get_hero, get_random_hero}, wasi::logging::logging::{log, Level}};
...
crate::bindings::export!(HeroFetcher with_types_in crate::bindings);
